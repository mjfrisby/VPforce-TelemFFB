...
class NewAircraftWizard(QDialog, Ui_NewAircraftWizard):
    ...
    friendly_class_names = {
        ...
        "DudeHelicopter": "Dude Helicopter"
    }
    internal_class_names = {v: k for k, v in friendly_class_names.items()}  # Build reverse lookup table

    mandatory_clone_types = ("HPGHelicopter", "SASHelicopter", "FlyInsideHelicopter", "DudeHelicopter") # Aircraft types with special treatment that must be cloned from a default profile
